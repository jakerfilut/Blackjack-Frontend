          ...
          <div>
            ...
            <div>
              ...
              <div>
                ...
                attention from the casino. By this reckoning, you should bet 1
                unit for a +1 count, all neutral counts, and all negative
                counts. A +2 count means 2 units, a +3 count means 3 units, a +4
                count means 4 units, and anything over +4 means you bet 5 units.
                Going over 5 units is likely to attract unwanted casino heat.
              </div>
              <br />
              <div>
                Using this system and perfect blackjack strategy, you can expect
                a positive return of about 0.14%. You’re not going to get rich
                with small wins under this system, but it will turn a negative
                expectation game into a positive one.
              </div>
              <br />
              <div>
                The only way to increase your expectation is to use a 1-10 unit
                bet spread, which is sure to get you kicked out of any casino
                eventually. Still, as long as you can get away with a 1-10 unit
                spread, you can play with an edge of about 0.57%, or about three
                and a half times greater than with a 1-5 unit spread.
              </div>
              <br />
              <div>
                Since casinos have implemented rules and strategies to
                counteract card counting, the easy to beat blackjack tables have
                disappeared. Casinos are now instituting a 6:5 blackjack payout
                rule, for instance, that automatically makes the game not worth
                the time it takes to count cards and develop a bet spread.
                Perfect blackjack strategy is often as good as you can get at
                today’s blackjack tables, since even the most aggressive
                counting and bet spreading gives you only about a .5% edge.
              </div>
            </div>
          </div>
        </div>
